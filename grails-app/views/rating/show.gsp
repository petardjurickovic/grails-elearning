...
<html>
    ...
    <body>
        ...
        <div id="show-rating" class="content scaffold-show" role="main">
            ...
            <f:display bean="rating" />
            <g:form resource="${this.rating}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.rating}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
